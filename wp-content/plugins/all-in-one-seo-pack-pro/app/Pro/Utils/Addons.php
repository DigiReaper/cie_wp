...
class Addons extends CommonUtils\Addons {
	...
	public function getMinimumVersion( $slug ) {
		$minimumVersions = [
			'aioseo-image-seo'      => '1.1.1',
			'aioseo-link-assistant' => '1.0.10',
			'aioseo-local-business' => '1.2.11',
			'aioseo-news-sitemap'   => '1.0.10',
			'aioseo-redirects'      => '1.2.4',
			'aioseo-video-sitemap'  => '1.1.7',
